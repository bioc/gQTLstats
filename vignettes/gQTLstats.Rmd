...
- Definition of variant context.  In this example we use ChromHMM states for NA12878, along with other information assembled in the store on MAF and distance
