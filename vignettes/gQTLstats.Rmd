...
prst = makeGeuvStore2() #ciseStore(partialRegistry(), partialIds(), FALSE, FALSE)
```
...
data(hmm878)
library(geuvStore2)
prst = makeGeuvStore2() #ciseStore(partialRegistry(), partialIds(), TRUE, FALSE)
...
```{r dovaranno,cache=FALSE,eval=FALSE}
suppressPackageStartupMessages({
